...
public class TestJoinWEmptyEquivalenceClass {

    @Test
    public void testJoinWithEmptyEquivalenceClass() throws Exception {

        ExecutionEnvironment env = ExecutionEnvironment.getExecutionEnvironment();

        DataSource visitSource = env.readTextFile(Config.pathToVisits());
        DataSource urlSource = env.readTextFile(Config.pathToUnMatchingUrls());
